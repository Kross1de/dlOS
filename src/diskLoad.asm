...
disk_load:
	...
	mov dh, 0x00 		; head 0
	mov cl, 0x02 		; start reading at CL sector (sector 2 in this case, right after bootsector)
	...
	cmp dh, al 		; if AL(# of sector actually read) != DH (# sectors we wanted to read)
